...
<?php if (config("sirgrimorum_cms.css_section") != "") { ?>
...
if (str_contains(config("sirgrimorum_cms.jquerytables_path"), ['http', '://'])) {
    echo '<link href="' . config("sirgrimorum_cms.jquerytables_path") . '" rel="stylesheet" type="text/css">';
} else {
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/jquery.dataTables.min.css") . '" rel="stylesheet" type="text/css">';
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/dataTables.bootstrap.css") . '" rel="stylesheet" type="text/css">';
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/dataTables.colReorder.min.css") . '" rel="stylesheet" type="text/css">';
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/dataTables.fixedHeader.min.css") . '" rel="stylesheet" type="text/css">';
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/dataTables.responsive.css") . '" rel="stylesheet" type="text/css">';
    echo '<link href="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/css/dataTables.tableTools.min.css") . '" rel="stylesheet" type="text/css">';
}
if (str_contains(config("sirgrimorum_cms.confirm_path"), ['http', '://'])) {
    echo '<link href="' . config("sirgrimorum_cms.confirm_path") . '" rel="stylesheet" type="text/css">';
} else {
    echo '<link href="' . asset(config("sirgrimorum_cms.confirm_path") . "/css/jquery-confirm.min.css") . '" rel="stylesheet" type="text/css">';
}
...
if (str_contains(config("sirgrimorum_cms.jquerytables_path"), ['http', '://'])) {
    //echo '<script src="' . config("sirgrimorum_cms.jquerytables_path") . '"></script>';
} else {
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/jquery.dataTables.min.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/dataTables.bootstrap.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/dataTables.colReorder.min.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/dataTables.fixedHeader.min.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/dataTables.responsive.min.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.jquerytables_path") . "/js/dataTables.tableTools.min.js") . '"></script>';
}
if (str_contains(config("sirgrimorum_cms.confirm_path"), ['http', '://'])) {
    echo '<script src="' . config("sirgrimorum_cms.confirm_path") . '"></script>';
    echo '<script src="' . asset("vendor/sirgrimorum_cms/confirm/js/rails.js") . '"></script>';
} else {
    echo '<script src="' . asset(config("sirgrimorum_cms.confirm_path") . "/js/jquery-confirm.min.js") . '"></script>';
    echo '<script src="' . asset(config("sirgrimorum_cms.confirm_path") . "/js/rails.js") . '"></script>';
}
?>
<script>
