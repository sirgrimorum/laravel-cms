 ...
 * structure:
            ...
            "campos" => [ // list of fields structure 
                "[field/attribute name]" => [ //as apears in the model if used for db save with url "Sirgrimorum_CrudAdministrator"
                    ...
                    "label" => "[text of the label]", // required for all types, use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.labels.name__",
                    "placeholder" => "[placeholder text]", // required for text, textarea, email, password and number types, use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.placeholders.name__",
                    "description" => "[description text]", // use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.descriptions.name__",
                    "valor" => "[default value of the field]", // use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.default_values.name__",
                    "value" => "[value or lists of values to be taken by de field]", // required for checkbox and radio types, mainly for the checkbox and radio use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.default_values.name__",
                    "enlace" => "[url for link in show or lists views]", // use :modelId or :modelName to change it for de id or name of the object, use the 'trans_prefix' value if you want localization ej: url("__trans__sirgrimorum_cms::article.menu.links.usuario__", array(":modelId"),
                    "opciones" => [] // required for select type, array of options, use the 'trans_prefix' value if you want localization ej: "__trans__sirgrimorum_cms::article.selects.options__"
